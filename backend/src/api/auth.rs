use axum::{
    ...
    extract::{rejection::{ExtensionRejection, TypedHeaderRejection},FromRequest, RequestParts},
    Json,
    http::StatusCode,
};
    ...
    B: Send,
{
    ...
    async fn from_request(req: &mut RequestParts<B>) -> Result<Self, Self::Rejection> {
        ...
        let user_id = conn.interact(move |conn| {
            conn.query_row(
            ...
            .optional()
        }).await.unwrap().map_err(anyhow::Error::new)?;
